...
namespace XWingSquadronBuilder_v4.Presentation.Converters
{
    public class TextToItemsConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            string[] splitText = ((string)value).Split(' ');
            ...
            foreach (var item in splitText)
            {
                ...
                {
                    textblocks.Add(new TextBlock() { Text = xwingKeyWords[wordSplit[1]], FontFamily = new FontFamily("x-wing-symbols"), Margin = new Windows.UI.Xaml.Thickness(2,0,2,0), FontSize = fontSize, VerticalAlignment = Windows.UI.Xaml.VerticalAlignment.Center });                    
                }
                else
                {
