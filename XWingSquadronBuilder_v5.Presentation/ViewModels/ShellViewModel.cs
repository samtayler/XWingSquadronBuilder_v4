...
using XWingSquadronBuilder_v5.Presentation.Helpers;
...
namespace XWingSquadronBuilder_v5.Presentation.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_Main".GetLocalized(), Symbol.Home, typeof(MainPage.MainViewModel).FullName));
